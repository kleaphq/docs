...
<Frame caption="Use Refresh, Edit, and Version history while diagnosing a problem">
  <img src="/images/tutorials/editor-toolbar.webp" alt="Kleap builder controls in English including Refresh and Edit" />
</Frame>
...
4. AI has context to fix it

<Frame caption="Edit elements lets you point the AI at the exact broken element">
  <img src="/images/tutorials/edit-elements.webp" alt="Kleap Edit elements instruction in English" />
</Frame>
...
<Frame caption="Open Version History to recover a working state">
