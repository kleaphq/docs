...
<Frame caption="Describe what to build, choose an AI mode, then click Create">
  <img src="/images/tutorials/create-from-prompt.webp" alt="Kleap creation screen in English with the AI mode and Create controls" />
</Frame>
...
<Frame caption="The builder toolbar keeps Edit and other actions within reach">
  <img src="/images/tutorials/editor-toolbar.webp" alt="Kleap builder toolbar in English showing Edit and other actions" />
</Frame>
