...
<Frame caption="Describe the data and account behavior in the prompt composer">
  <img src="/images/tutorials/create-from-prompt.webp" alt="Kleap prompt composer in English" />
</Frame>
...
Once a database is added, open **Settings > Project settings > Data Management** to browse the project's data — no SQL required.

<Frame caption="Project data is available from Settings > Data Management">
