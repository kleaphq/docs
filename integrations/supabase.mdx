...
<Frame caption="Open Settings > Project settings > Integrations, then choose Supabase">
  <img src="/images/tutorials/integrations.webp" alt="Kleap Integrations catalog in English showing Supabase" />
</Frame>
...
<Steps>
  ...
  <Step title="Add the keys and wire it up">
    In Kleap, open **Settings > Project settings > Integrations**, choose **Supabase**, and click **Configure**. Then describe what you want to the AI:
