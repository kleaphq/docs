...
<Frame caption="Stripe is available from Settings > Project settings > Integrations">
  <img src="/images/tutorials/integrations.webp" alt="Kleap Integrations catalog in English showing Stripe and other integrations" />
</Frame>
