...
<Frame caption="Start from the English creation screen, then continue refining in chat">
  <img src="/images/tutorials/create-from-prompt.webp" alt="Kleap creation screen in English with a prompt field and Create button" />
</Frame>
