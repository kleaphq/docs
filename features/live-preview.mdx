...
<Info>
  Publishing and hosting are free — they don't use credits. Sites are served on Cloudflare's global edge with automatic HTTPS. For custom domains, see [custom domains](/features/custom-domains).
</Info>
...
| Output | Real build | Same build, on Cloudflare's global edge |
