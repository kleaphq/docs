...
1. Open your project
2. Click **Settings** in the builder toolbar
3. Choose **Project settings**
4. Open **Data Management** under **Data**
5. Browse submissions with dates and user information

<Frame caption="Form submissions are managed from Settings > Data Management">
  <img src="/images/tutorials/data-management.webp" alt="Kleap Data Management settings in English" />
</Frame>
...
1. Open your project
2. Open **Settings** > **Project settings** > **Data Management**
3. Open the form's integrations
...
<Frame caption="Open Data Management before selecting a form and exporting its submissions">
  <img src="/images/tutorials/data-management.webp" alt="Kleap Data Management panel in English" />
</Frame>
...
2. Click any text block in the preview
3. Edit directly in the text editor
4. Click outside to save
5. Changes apply immediately

<Frame caption="Enable Edit elements before selecting text in the preview">
