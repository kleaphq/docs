...
<Info>
  Forms work on both preview URLs and published sites. All data is automatically backed up.
</Info>
...
<Card title="Upgrade to Pro" icon="crown" href="/introduction/pricing">
...
A: Yes! Forms work identically on preview URLs and published sites.
...
A: Yes! Forms use Tailwind CSS and shadcn/ui components. Ask the AI to customize appearance.
