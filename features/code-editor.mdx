...
<Frame caption="Open Settings, then choose View code">
  <img src="/images/tutorials/settings-menu.webp" alt="Kleap Settings menu in English with Project settings and View code" />
</Frame>
...
4. Create or connect a repository
5. Push your code

<Frame caption="GitHub is available from the Integrations catalog">
