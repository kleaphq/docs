...
You can purchase a domain directly in Kleap (**Settings > Domains**), or use one you already own from:
...
1. Click **Settings** in the builder toolbar
2. Open **Project settings**
3. Choose **Domains** under **Distribution**
4. Choose **Buy New**, **Transfer**, or **Connect Existing**
5. Enter your domain (e.g., `myapp.com`)
6. Copy the DNS records shown

<Frame caption="The Domains page is under Distribution in Project settings">
