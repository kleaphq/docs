...
<Frame caption="Describe the product, choose the format, then click Create">
...
<Frame caption="Check the address in the Publish panel before going live">
...
<Frame caption="Custom domains are managed under Settings > Domains">
  <img src="/images/tutorials/domains.webp" alt="Kleap Domains settings in English" />
</Frame>
