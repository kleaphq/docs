...
<Info>
  For a permanent, public URL, [publish the reviewed draft](/features/publishing)
  to `https://your-app.kleap.io`.
</Info>

## Publishing

Publishing is **deliberate**. When the preview is ready, open **Publish**, check
the address, and click **Publish** in the panel. Kleap builds your site and deploys
it to a global edge network at `https://your-app.kleap.io` with free SSL.

<Frame caption="The Publish panel is the boundary between preview and production">
...
<AccordionGroup>
  <Accordion title="Is there a dev sandbox I need to keep running?">
    ...
    demand for preview and again when you choose Publish or Update.
  </Accordion>
  ...
  <Accordion title="Why doesn't my preview match the live site yet?">
    ...
    next Publish or Update build finishes.
  </Accordion>
