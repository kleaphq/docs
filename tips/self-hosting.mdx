...
Kleap provides built-in hosting when you deliberately publish to
...
3. Push your code to a repository
4. Clone the repository locally

<Frame caption="Connect GitHub from the Integrations catalog">
...
Open **Settings** and choose **View code** to inspect the project before pushing it to GitHub.

<Frame caption="Use View code to inspect the project source">
  <img src="/images/tutorials/settings-menu.webp" alt="Kleap Settings menu in English showing View code" />
</Frame>
