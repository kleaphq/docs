...
<Frame caption="Use Refresh in the preview toolbar when the build looks stale">
  <img src="/images/tutorials/editor-toolbar.webp" alt="Kleap builder toolbar in English with Refresh" />
</Frame>
...
<Frame caption="Environment Variables is under Build in Project settings">
  <img src="/images/tutorials/domains.webp" alt="Kleap Project settings navigation in English showing Environment Variables" />
</Frame>
