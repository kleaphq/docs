...
<Frame caption="Use the Add control beside the English prompt composer to attach an image">
  <img src="/images/tutorials/create-from-prompt.webp" alt="Kleap creation screen in English with the Add control" />
</Frame>
