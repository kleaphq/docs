...
<Frame caption="The Publish panel shows the address and deployment action">
  <img src="/images/tutorials/publish.webp" alt="Kleap Publish panel in English with the deployment button" />
</Frame>
