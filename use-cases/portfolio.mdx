...
<Frame caption="Describe the portfolio or choose Portfolio from the quick ideas">
  <img src="/images/tutorials/create-from-prompt.webp" alt="Kleap creation screen in English with Portfolio among the quick ideas" />
</Frame>
