...
<Frame caption="Choose the starting format and describe the SaaS before clicking Create">
...
<Frame caption="Deploy the reviewed SaaS from the Publish panel">
  <img src="/images/tutorials/publish.webp" alt="Kleap Publish panel in English" />
</Frame>

<Frame caption="Manage the optional custom domain under Settings > Domains">
