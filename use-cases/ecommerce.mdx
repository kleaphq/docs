...
<Frame caption="Start the store from a focused product prompt and choose Web app or site">
...
<Frame caption="Publish the reviewed store from the English deployment panel">
  <img src="/images/tutorials/publish.webp" alt="Kleap Publish panel in English" />
</Frame>

<Frame caption="Connect the final domain from Settings > Domains">
