...
Product data can be hardcoded in your site or stored in **Kleap Database** — a managed Postgres database built into Kleap (no separate account to connect).
...
- **Kleap Database** — a managed Postgres database built into Kleap (no separate account). Best when you want to add or edit products without redeploying.
