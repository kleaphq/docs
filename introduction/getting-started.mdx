...
Hosting is free, on Cloudflare's global edge with automatic SSL.
...
<CardGroup cols={2}>
  ...
  <Card title="Add a database" icon="database" href="/integrations/supabase">
    Turn on Kleap Database — Postgres and user accounts, built in
  </Card>
